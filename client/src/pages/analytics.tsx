...
export default function Analytics() {
  ...
  const updateStatMutation = useMutation({
    mutationFn: async (data: { key: string; value: string | number }) => {
      await apiRequest("PATCH", "/api/stats", { [data.key]: data.value });
    },
    onSuccess: () => {
              ...
              <CardContent className="p-6">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    ...
                    {editingStat === "activeParcels" ? (
                      <span className="ml-2">
                        <input
                          type="number"
                          className="border rounded px-2 py-1 w-20 text-base"
                          value={editValue}
                      ...
                      <Button
                        ...
                        className="ml-2"
                        onClick={() => {
                          setEditingStat("activeParcels");
                          setEditValue(stats?.activeParcels?.toString() || "");
                        }}
                      >
                        Edit
                      </Button>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    ...
                    {editingStat === "onTimeRate" ? (
                      ...
                      <Button
                        ...
                        className="ml-2"
                        onClick={() => {
                          setEditingStat("onTimeRate");
                          setEditValue(stats?.onTimeRate || "");
                        }}
                      >
                        Edit
                      </Button>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    ...
                    {editingStat === "delayedParcels" ? (
                      ...
                      <Button
                        ...
                        className="ml-2"
                        onClick={() => {
                          setEditingStat("delayedParcels");
                          setEditValue(stats?.delayedParcels?.toString() || "");
                        }}
                      >
                        Edit
                      </Button>
              ...
              <CardContent className="p-6">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    ...
                    {editingStat === "weatherImpactPercentage" ? (
                      <span className="ml-2">
                        <input
                          type="text"
                          className="border rounded px-2 py-1 w-20 text-base"
                      ...
                      <Button
                        ...
                        className="ml-2"
                        onClick={() => {
                          setEditingStat("weatherImpactPercentage");
                          setEditValue(stats?.weatherImpactPercentage || "");
                        }}
                      >
                        Edit
                      </Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  On-time vs. delayed deliveries over time
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  ...
                  <TabsContent value="delays" className="mt-0 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h3 className="font-medium text-sm mb-3">
                          Delay Impact by Transport Mode
                        </h3>
                        <div className="h-64">
                          <ResponsiveContainer width="100%" height="100%">
                            <BarChart
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-slate-600 mb-4">
                        Based on current weather and traffic patterns, the following
                        routes have high delay risk:
                      </p>
